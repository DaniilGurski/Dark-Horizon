...
export class Transition extends Scene {
  ...
  create() {
    ...
    this.ship1 = this.physics.add
      .sprite(0, height / 2, "ship-1")
      .setScale(2)
      .setOrigin(1, 0.5);
    this.ship2 = this.physics.add
      .sprite(0, height / 2 - this.shipDistance, "ship-2")
      .setScale(2)
      .setOrigin(1, 0.5);
    this.ship3 = this.physics.add
      .sprite(0, height / 2 + this.shipDistance, "ship-3")
      .setScale(2)
      .setOrigin(1, 0.5);
